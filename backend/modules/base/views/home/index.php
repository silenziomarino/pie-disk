...
use backend\modules\base\assets\home\HomeBundle;
...
<div class="page-content">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                <label class="col-sm-5 control-label">документы пользователя</label>
                <div class="col-sm-7">
                    <?= Html::activeDropDownList($model, 'user_create', $dic_profile,[
                        'id'     => 'UserCreate',
                        'class'  => 'form-control input-sm',
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <?= Html::activeDropDownList($model, 'teg', [],[
                        'id'               => 'Teg',
                        'class'            => 'chosen-select',
                        'multiple'         => 'multiple',
                        'data-placeholder' => 'начните вводить слово'
                    ]) ?>
